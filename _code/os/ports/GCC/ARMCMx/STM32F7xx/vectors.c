...
/**
 * @file    GCC/ARMCMx/STM32F7xx/vectors.c
 * @brief   Interrupt vectors for the STM32F7xx family.
 *
 * @defgroup ARMCMx_STM32F7xx_VECTORS STM32F7xx Interrupt Vectors
 * @ingroup ARMCMx_SPECIFIC
 * @details Interrupt vectors for the STM32F7xx family.
 * @{
 */
